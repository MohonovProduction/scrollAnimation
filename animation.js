const app = new Vue({
    ...
    data: {
        ...
        gallery: {
            imgs: [
                { src: 'assets/img/placeholder-image.jpg', alt: 'placeholder' },
                { src: 'assets/img/placeholder-image.jpg', alt: 'placeholder' },
                { src: 'assets/img/placeholder-image.jpg', alt: 'placeholder' },
            ],
            imgOpen: {
    ...
    methods: {
        /*
        * Open img
        * 1. Add class gallery_big-img on gallery_big-img--opened
        * 2.
        * */
        openImage(obj) {
            console.log(1)
            for (let [key, value] of Object.entries(obj)) this.gallery.imgOpen[key] = value
            this.gallery.imgOpen.isOpened = true
        },
        closeImage() {
            console.log(2)
            this.gallery.imgOpen.isOpened = false
        }
    }
})
